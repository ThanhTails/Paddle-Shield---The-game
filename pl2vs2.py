...
def arena_2_vs_2():
  ...
  while not done:
    ...
    #health p1
    if players1.life>=3:
      hp1=fonts.render("Team 1 Hp: "+str(players1.life),True,green)
    if players1.life==2:
      hp1=fonts.render("Team 1 Hp: "+str(players1.life),True,yellow)
    if players1.life==1:
      hp1=fonts.render("Team 1 Hp: "+str(players1.life),True,red)
    #health p2
    if players2.life>=3:
      hp2=fonts.render("Team 2 Hp: "+str(players2.life),True,green)
    if players2.life==2:
      hp2=fonts.render("Team 2 Hp: "+str(players2.life),True,yellow)
    if players2.life==1:
      hp2=fonts.render("Team 2 Hp: "+str(players2.life),True,red)
    #show a point and life
    main.blit(pointp1,(200,5))    
    main.blit(pointp2,(400,5))    
    main.blit(hp1,(200,485))    
    main.blit(hp2,(400,485)) 
    if players1.life<=0:
